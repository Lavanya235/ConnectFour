...
public class Main extends Application {
    ...
    private MenuBar createMenu(){
        ...
        newGame.setOnAction(event -> resetGame()); //or controller.resetGame();
    ...
    private void aboutMe() {
        ...
        alert.setHeaderText("Lavanya Tyagi");
        alert.setContentText("Suffice it to say i am awesome and i code awesomely. " +
                "I like the word awesome and i developed this awesome game. " +
                "Play it and tell me....Am i right or Am i right?");
